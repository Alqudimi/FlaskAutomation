...
if __name__ == "__main__":
    try:
        ...
        print("2. Brute-Force Matching with SIFT Descriptors and Ratio Test")
        print("3. Brute-Force Matching with ORB Descriptors and Ratio Test")
        ...
        # إنشاء كائن مطابقة الميزات
        matcher = FeatureMatching(img1, img2)
        
        # اكتشاف الميزات والمطابقة
